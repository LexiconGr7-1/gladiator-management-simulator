...
namespace Gladiator.Presentation.Api.Controllers
{
    ...
    public class GladiatorControllerOld : ControllerBase
    {
        ...
        private static List<Gladiator.Presentation.Models.Gladiator> gladiators = new()
        {
            ...
            new Gladiator.Presentation.Models.Gladiator {Name = "Gladiator 3", Id = 3, Strength = 3, Health = 3},
            new Gladiator.Presentation.Models.Gladiator {Name = "Gladiator 4", Id = 4, Strength = 4, Health = 4},
            new Gladiator.Presentation.Models.Gladiator {Name = "Gladiator 5", Id = 5, Strength = 5, Health = 5},
            new Gladiator.Presentation.Models.Gladiator {Name = "Gladiator 6", Id = 6, Strength = 6, Health = 6},
            new Gladiator.Presentation.Models.Gladiator {Name = "Gladiator 7", Id = 7, Strength = 7, Health = 7},
            new Gladiator.Presentation.Models.Gladiator {Name = "Gladiator 8", Id = 8, Strength = 8, Health = 8},
            new Gladiator.Presentation.Models.Gladiator {Name = "Gladiator 9", Id = 9, Strength = 9, Health = 9},
            new Gladiator.Presentation.Models.Gladiator {Name = "Gladiator 10", Id = 10, Strength = 10, Health = 10}
        };
